      ...
      <div class="row">
        ...
        <div class="col-md-12">
          ...
          <div class="card card-primary">
            ...
            <!-- /.card-header -->
            <!-- form start -->
            <form method="post" action="/dashboard/imunisasis/{{ $imun->id }}" class="mb-5" enctype="multipart/form-data">
              @method('put')
              @csrf
              <div class="card-body">
                <div class="container">
                    <div class="row">
                        ...
                        <div class="col-md-12">
                            ...
                            <div class="input-group mb-3">
                                ...
                                <select class="form-control @error('anak_id') is-invalid @enderror" name="anak_id">
                                    ...
                                    <option value="{{ $anak->id }}" {{ old('anak_id', $imun->anak_id) == $anak->id ? ' selected' : ' ' }}>{{ $anak->nama_anak }}</option>
                                    @endforeach
                                </select>
                                @error('anak_id')
                        ...
                        <div class="col-md-12">
                            ...
                            <div class="input-group mb-3">
                                ...
                                <select class="form-control @error('jenisimunisasi_id') is-invalid @enderror" name="jenisimunisasi_id">
                                    ...
                                    <option value="{{ $data->id }}" {{ old('jenisimunisasi_id', $imun->jenisimunisasi_id) == $data->id ? ' selected' : ' ' }}>{{ $data->nama_imun }}</option>
                                    @endforeach
                                </select>
                        ...
                        <div class="col-md-12">
                            ...
                            <div class="input-group mb-3">
                                ...
                                <select class="form-control @error('booster') is-invalid @enderror" name="booster">
                                    ...
                                    <option value="Ya" {{ old('booster', $imun->booster) == 'Ya' ? ' selected' : ' ' }}>Ya</option>
                                    <option value="Tidak" {{ old('booster', $imun->booster) == 'Tidak' ? ' selected' : ' ' }}>Tidak</option>
                                </select>
                                @error('booster')
                                <div class="invalid-feedback">
                                    {{ $message }}
                        ...
                        <div class="col-md-12">
                            ...
                            <div class="input-group mb-3">
                                ...
                                <input type="text" class="form-control @error('ket_imun') is-invalid @enderror" id="ket_imun" name="ket_imun" value="{{ old('ket_imun', $imun->ket_imun) }}" >
                                @error('ket_imun')
                                <div class="invalid-feedback">
                                    {{ $message }}
                                </div>
