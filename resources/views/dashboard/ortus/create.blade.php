      ...
      <div class="row mb-2">
        ...
        <div class="col-sm-6">
          <ol class="breadcrumb float-sm-right">
            ...
            <li class="breadcrumb-item active">Tambah Ortu</li>
          </ol>
        </div>
      </div>
    </div><!-- /.container-fluid -->
        ...
        <div class="col-md-12">
          ...
          <div class="card card-primary">
            <div class="card-header">
              <h3 class="card-title">Tambah Ortu</h3>
            </div>
            <!-- /.card-header -->
            <!-- form start -->
            <form method="post" action="/dashboard/ortus" class="mb-5" enctype="multipart/form-data">
              @csrf
              <div class="card-body">
                <div class="container">
                    <div class="row">
                        <div class="col-md-12">
                            ...
                            <div class="input-group mb-3">
                                ...
                                <input type="text" class="form-control @error('nama_ibu') is-invalid @enderror" id="nama_ibu" name="nama_ibu" value="{{ old('nama_ibu') }}" autofocus>
                                @error('nama_ibu')
                        ...
                        <div class="col-md-12">
                            ...
                            <div class="input-group mb-3">
                                ...
                                <input type="text" class="form-control @error('kk') is-invalid @enderror" id="kk" name="kk" value="{{ old('kk') }}">
                                @error('kk')
                                <div class="invalid-feedback">
                                    {{ $message }}
                                </div>
