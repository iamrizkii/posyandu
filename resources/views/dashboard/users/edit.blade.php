                ...
                <div class="col-md-8">
                    <div class="card card-success card-outline">
                        <div class="card-header">
                            <h3 class="card-title">Edit Data User: {{ $user->name }}</h3>
                        </div>
                                ...
                                <div class="form-group">
                                    ...
                                    <select class="form-control @error('level') is-invalid @enderror" id="level"
                                        ...
                                        <option value="admin" {{ old('level', $user->level) == 'admin' ? 'selected' : '' }}>
                                            Admin</option>
                                        <option value="bidan" {{ old('level', $user->level) == 'bidan' ? 'selected' : '' }}>
                                            Bidan</option>
                                        <option value="member" {{ old('level', $user->level) == 'member' ? 'selected' : '' }}>
                                            Member</option>
                                    </select>
                                    @error('level')
                                        <div class="invalid-feedback">{{ $message }}</div>
